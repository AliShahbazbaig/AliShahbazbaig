...
| [University Notes RAG Bot]([https://github.com/AliShahbazbaig/PDFS-Q-A](https://github.com/AliShahbazbaig/PDFS-Q-A)) | A Q&A bot built from scratch (no LangChain) that retrieves answers from PDF lecture notes using semantic search and an LLM. | Python, PyMuPDF, sentence-transformers, ChromaDB, FastAPI, OpenRouter (Mistral 7B), React, Vite |
